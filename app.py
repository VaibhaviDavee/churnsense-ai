...
@st.cache_resource
def load_model():
    model = pickle.load(open("saved_models/churn_model.pkl", "rb"))
    scaler = pickle.load(open("saved_models/standard_scaler.pkl", "rb"))
...
# HEADER
# -------------------------------------------------
st.markdown('<div class="logo">ChurnSense AI</div>', unsafe_allow_html=True)
st.markdown('<div class="tagline">ML-Powered Customer Churn Prediction & Retention Platform</div>', unsafe_allow_html=True)
...
st.markdown("---")
st.write("By Vaibhavi Dave • ML-Powered Customer Churn Prediction & Retention Platform")
